...
export function TermosPage() {
  return (
    <Shell title="Termos de uso">
      ...
      <p>
        Há dois planos anuais. O Essencial custa R$ 499,00 à vista ou 12 parcelas de R$ 49,00 (total R$ 588,00), com 1
        congregação e até 80 cadastros. O plano Igreja custa R$ 1.499,00 à vista ou 12 parcelas de R$ 149,90 (total
        R$ 1.798,80), com congregações ilimitadas e até 600 cadastros. A validade conta 12 meses a partir da data de
        contratação. O cadastro no site leva ao pagamento; o login e a senha inicial são enviados ao e-mail informado
        somente após a confirmação do pagamento, pelo endereço naoresponda@ebdtotal.com. O acesso no aplicativo segue o
        plano pago. O acesso pode ser suspenso em caso de inadimplência.
      </p>
